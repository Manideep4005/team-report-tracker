...
export default function Sidebar({ open, onClose }: SidebarProps) {
  ...
  /*
   * Account wrapper references.
   * Separate refs for mobile and desktop instances
   * since the same userCard markup is rendered twice.
   ...
   * (checks both mobile and desktop refs,
   * since only one is visible/interactive
   * at a time).
   */
  useEffect(() => {
  ...
  /*
   * Whether the Management section
   * has at least one visible item.
   * Prevents showing the section label
   * with no permitted links underneath.
   */
  ...
  const renderNavigation = (mobile = false) => (
    <nav className="sidebar-nav">
      ...
      {/* =================================================
                MANAGEMENT
                Only rendered (label + links) when the
                user has at least one Management permission
                ================================================= */}
  ...
  const brand = (
    <div className="sidebar-brand">
      ...
      <div className="min-w-0">
        <h1 className="sidebar-brand-title">Team Work</h1>

        <p className="sidebar-brand-subtitle">Report Tracker</p>
      </div>
    </div>
  );
   ...
   * Takes its own ref so mobile and desktop
  ...
  const renderUserCard = (
    ...
    <div ref={accountRef} className="relative">
      ...
      {accountOpen && (
        ...
        >
          ...
          <div className="sidebar-account-profile">
            <div className={`sidebar-account-avatar ${avatarColor}`}>
              {initials}
            </div>
      ...
      >
        {/* Avatar */}
        <div className={`sidebar-user-avatar ${avatarColor}`}>{initials}</div>
  ...
  return (
    <>
      ...
      >
        ...
        {/* Footer */}
        <div className="sidebar-footer">{renderUserCard(accountRefMobile)}</div>
      </aside>
      ...
      <aside className="sidebar-desktop z-[100]">
        ...
        <div className="sidebar-footer">
          {renderUserCard(accountRefDesktop)}
        </div>
      </aside>
    </>
  );
