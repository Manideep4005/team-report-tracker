...
export default function Users() {
  ...
  const [deleteUserTarget, setDeleteUserTarget] = useState<ManagedUser | null>(
    null,
  );
    ...
    >
      ...
      <h3
        className="
                ...
                "
      >
        {status === 403 ? "Access denied" : "Unable to load users"}
      </h3>
...
function EditUserModal({
  ...
  loading: boolean;
  onClose: () => void;
  onSubmit: (payload: { name: string; email: string; roleId: string }) => void;
}) {
