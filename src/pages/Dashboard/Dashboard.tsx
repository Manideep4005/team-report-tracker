...
interface DashboardResponse {
  ...
  reports: {
     ...
     * IMPORTANT:
     *
     * Your actual API response contains
     * userId directly on the report.
     */
    userId: string;
...
export default function Dashboard() {
   ...
   * IMPORTANT:
   *
   * We need the logged-in user ID so
   * the Copy button can identify which
  ...
  /*
   * This is only for the visual animation.
   *
   * It is NOT the actual completion
   ...
   * IMPORTANT:
   *
   * Use the completion value coming
  ...
  /*
   * Convert animated percentage
   * into SVG dash offset.
   */
  const ringOffset =
    RING_CIRCUMFERENCE *
    (
  ...
  useEffect(() => {
    ...
    const animate = (
       ...
       * IMPORTANT:
       *
       * Do NOT round every frame.
       *
       * Keep decimal precision during
       * animation so the SVG movement
       * remains smooth.
       */
      const currentValue =
        progress *
  ...
  const handleCopyReports =
    async () => {
       ...
       *
       * We must NOT mutate
       * data.reports because
       * it is React Query data.
       */
      const reports =
        [
          ...data.reports,
       ...
       *
       * Manideep:
       * d89b65e1-da3f-4b00-a18c-478c89d43ff6
       *
       * Therefore compare:
       *
       * report.userId
      ...
      /*
       * If the logged-in user's
       * report isn't already first,
       * move only that report
       * to position 0.
       *
      ...
      try {
        ...
        if (
          ...
          toast.success(
            "Team reports copied successfully."
          );
                ...
                <div>
                  ...
                  <p
                    className="
                                            ...
                                            dark:text-rose-400/65
                                        "
                  >
                    Please submit today's
                    work report before
                    leaving.
                  </p>
          ...
          >
            ...
            <div
              className="
                                ...
                                dark:focus-within:border-indigo-500/30
