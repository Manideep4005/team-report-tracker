...
export default function Login() {
  ...
  return (
    ...
    <div className="flex min-h-screen w-full bg-white dark:bg-slate-950">
      ...
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-[#0B1220] px-14 py-12 lg:flex xl:px-20">
        ...
        <div className="relative max-w-md">
          <h2 className="text-[40px] font-semibold leading-[1.12] tracking-tight text-white">
            Every report,
            <br />
            one place.
          </h2>
          <p className="mt-5 max-w-[32ch] text-[15px] leading-relaxed text-slate-400">
          ...
          <div className="mt-10">
            <svg viewBox="0 0 240 64" className="h-16 w-full max-w-[280px]" fill="none">
              <defs>
        ...
        <div className="relative flex items-center justify-between border-t border-white/[0.07] pt-6">
          <div>
      ...
      <div className="flex w-full flex-col justify-center px-8 sm:px-16 lg:w-1/2 lg:px-20 xl:px-24">
        ...
        <div className="w-full max-w-[360px] animate-[loginFadeIn_0.4s_ease-out]">
          ...
          <form onSubmit={handleLogin} className="mt-8 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-slate-300 bg-white px-3.5 py-2.5 text-[14px] text-slate-900 outline-none transition-colors placeholder:text-slate-400 focus:border-blue-500 focus:ring-[3px] focus:ring-blue-500/15 dark:border-slate-700 dark:bg-slate-900 dark:text-white dark:placeholder:text-slate-600"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="!mt-7 flex w-full items-center justify-center gap-2 rounded-lg bg-blue-600 py-2.5 text-[14px] font-semibold text-white transition-colors hover:bg-blue-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60 dark:focus-visible:ring-offset-slate-950"
            >
              {loading && (
          ...
          <p className="mt-10 text-[12px] text-slate-400 dark:text-slate-600">
            Team Report Tracker
          </p>
